...
Else
    @<ul class="nav navbar-nav navbar-right">
        ...
        <li>@Html.ActionLink("Log in", "Login", "Account", routeValues:=New With {.ReturnURL = HttpContext.Current.Request.Url.AbsoluteUri}, htmlAttributes:=New With {.id = "loginLink"})</li>
    </ul>
End If
